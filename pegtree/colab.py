...
def pasm(grammar_file, configuration=''):
    ...
    Args:
        ...
        configuration (str, optional): [description]. Defaults to ''.
    """
...
def jsonfy(grammar_file: str, input_string: str):
    """a json string by converting an input_string using pegtree grammar_file
    ...
    Returns:
        str: a json string generated by `json.dumps`
    """
    start, path = start_option(grammar_file.strip())
...
def jsontree(grammar_file, input_string=''):
    """a json-encoded tree by converting an input_string using pegtree grammar_file
